...
type WildcardReportData struct {
	...
	//	*WildcardReportData_ServerTickData
...
func (x *WildcardReportData) GetServerTickData() *ServerTickData {
	if x, ok := x.GetData().(*WildcardReportData_ServerTickData); ok {
		return x.ServerTickData
	}
	return nil
}
...
type WildcardReportData_ServerTickData struct {
	ServerTickData *ServerTickData `protobuf:"bytes,13,opt,name=server_tick_data,json=serverTickData,proto3,oneof"`
}
...
func (*WildcardReportData_ServerTickData) isWildcardReportData_Data() {}
...
type PlayerAddEffectData struct {
	...
	Effect           *EffectFeature `protobuf:"bytes,1,opt,name=effect,proto3" json:"effect,omitempty"`
	InternalEffectId string         `protobuf:"bytes,2,opt,name=internalEffectId,proto3" json:"internalEffectId,omitempty"`
}
...
func (x *PlayerAddEffectData) GetEffect() *EffectFeature {
	if x != nil {
		return x.Effect
	}
	return nil
...
func (x *PlayerAddEffectData) GetInternalEffectId() string {
	if x != nil {
		return x.InternalEffectId
	}
	return ""
}
...
type PlayerRemoveEffectData struct {
	...
	InternalEffectId string `protobuf:"bytes,1,opt,name=internalEffectId,proto3" json:"internalEffectId,omitempty"`
}
...
func (x *PlayerRemoveEffectData) GetInternalEffectId() string {
	if x != nil {
		return x.InternalEffectId
	}
	return ""
...
type ServerTickData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ServerTickData) Reset() {
	*x = ServerTickData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_player_wrappers_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ServerTickData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerTickData) ProtoMessage() {}

func (x *ServerTickData) ProtoReflect() protoreflect.Message {
	mi := &file_player_wrappers_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServerTickData.ProtoReflect.Descriptor instead.
func (*ServerTickData) Descriptor() ([]byte, []int) {
	return file_player_wrappers_proto_rawDescGZIP(), []int{13}
}
...
var file_player_wrappers_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x07, 0x0a, 0x12, 0x57, 0x69, 0x6c, 0x64, 0x63, 0x61,
	...
	0x44, 0x61, 0x74, 0x61, 0x12, 0x43, 0x0a, 0x10, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x74,
	0x69, 0x63, 0x6b, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x54,
	0x69, 0x63, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x48, 0x00, 0x52, 0x0e, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x54, 0x69, 0x63, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74,
	...
	,
...
var file_player_wrappers_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_player_wrappers_proto_goTypes = []interface{}{
	...
	(*ServerTickData)(nil),           // 13: xchange.ServerTickData
	(*EntityPositionData)(nil),       // 14: xchange.EntityPositionData
	(PlayerAction)(0),                // 15: xchange.PlayerAction
	(*BlockData)(nil),                // 16: xchange.BlockData
	(ConsumeStatus)(0),               // 17: xchange.ConsumeStatus
	(*AttackData)(nil),               // 18: xchange.AttackData
	(*EffectFeature)(nil),            // 19: xchange.EffectFeature
	(GameMode)(0),                    // 20: xchange.GameMode
	(*Vec3F)(nil),                    // 21: xchange.Vec3f
	(InputMode)(0),                   // 22: xchange.InputMode
	(*ItemData)(nil),                 // 23: xchange.ItemData
}
var file_player_wrappers_proto_depIdxs = []int32{
	...
	13, // 12: xchange.WildcardReportData.server_tick_data:type_name -> xchange.ServerTickData
	14, // 13: xchange.PlayerActionData.position:type_name -> xchange.EntityPositionData
	15, // 14: xchange.PlayerActionData.action:type_name -> xchange.PlayerAction
	14, // 15: xchange.PlayerMoveData.newPosition:type_name -> xchange.EntityPositionData
	14, // 16: xchange.PlayerPlaceBlockData.position:type_name -> xchange.EntityPositionData
	16, // 17: xchange.PlayerPlaceBlockData.placedBlock:type_name -> xchange.BlockData
	14, // 18: xchange.PlayerBreakBlockData.position:type_name -> xchange.EntityPositionData
	16, // 19: xchange.PlayerBreakBlockData.brokenBlock:type_name -> xchange.BlockData
	17, // 20: xchange.PlayerEatFoodData.status:type_name -> xchange.ConsumeStatus
	18, // 21: xchange.PlayerAttackData.data:type_name -> xchange.AttackData
	19, // 22: xchange.PlayerAddEffectData.effect:type_name -> xchange.EffectFeature
	20, // 23: xchange.PlayerGameModeData.gameMode:type_name -> xchange.GameMode
	21, // 24: xchange.PlayerMotionData.motion:type_name -> xchange.Vec3f
	22, // 25: xchange.PlayerInputModeData.inputMode:type_name -> xchange.InputMode
	23, // 26: xchange.PlayerHeldItemChangeData.item:type_name -> xchange.ItemData
...
func file_player_wrappers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_player_wrappers_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServerTickData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_player_wrappers_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*WildcardReportData_ServerTickData)(nil),
	}
	type x struct{}
