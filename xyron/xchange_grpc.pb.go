...
func (c *anticheatClient) Report(ctx context.Context, in *ReportData, opts ...grpc.CallOption) (*ReportResponse, error) {
...
func (c *anticheatClient) ReportBatched(ctx context.Context, in *BatchedReportData, opts ...grpc.CallOption) (*BatchedReportResponse, error) {
	out := new(BatchedReportResponse)
	err := c.cc.Invoke(ctx, "/xchange.Anticheat/ReportBatched", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnticheatServer) Report(context.Context, *ReportData) (*ReportResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Report not implemented")
}
func (UnimplementedAnticheatServer) ReportBatched(context.Context, *BatchedReportData) (*BatchedReportResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportBatched not implemented")
}
...
func _Anticheat_Report_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnticheatServer).Report(ctx, req.(*ReportData))
	}
	return interceptor(ctx, in, info, handler)
}

func _Anticheat_ReportBatched_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchedReportData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnticheatServer).ReportBatched(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xchange.Anticheat/ReportBatched",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnticheatServer).ReportBatched(ctx, req.(*BatchedReportData))
	}
	return interceptor(ctx, in, info, handler)
}
